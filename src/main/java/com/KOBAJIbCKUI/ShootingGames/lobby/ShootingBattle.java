...
import com.KOBAJIbCKUI.ShootingGames.buffers.Cube;
import com.KOBAJIbCKUI.ShootingGames.buffers.PlayerGlower;
import com.KOBAJIbCKUI.ShootingGames.events.EndBattleEvent;
import org.bukkit.*;
...
public class ShootingBattle {
    ...
    private class BattleOversIn10Minutes implements Runnable {
    ...
    private class BattleOversIn1Minute implements Runnable {
    ...
    private class BattleOver implements Runnable {
